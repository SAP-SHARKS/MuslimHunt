        ...
        <div className="min-h-screen bg-white py-12 px-4 sm:px-6 lg:px-8 animate-in fade-in duration-700">
            <div className="max-w-2xl mx-auto">
                <div className="text-center mb-12">
                    ...
                    <div className="h-10 w-64 bg-primary-light/50 rounded-xl mx-auto mb-3 animate-pulse" />
                    <div className="h-6 w-48 bg-primary-light/30 rounded-lg mx-auto animate-pulse" />
                </div>
                ...
                <div className="space-y-12">
                    ...
                    <section className="bg-white border border-gray-100 rounded-[2.5rem] p-8 sm:p-10 shadow-sm relative overflow-hidden">
                        <div className="flex items-center gap-3 mb-8">
                            <div className="w-10 h-10 bg-primary-light rounded-xl animate-pulse" />
