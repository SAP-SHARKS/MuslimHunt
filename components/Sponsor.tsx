    ...
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative py-32 sm:py-48 overflow-hidden bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary-light text-primary rounded-full mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <h1 className="text-6xl sm:text-8xl font-black text-gray-900 mb-8 max-w-5xl mx-auto leading-[0.9] tracking-tighter animate-in fade-in slide-in-from-bottom-6 duration-1000">
            Reach millions of <br/><span className="text-primary italic font-serif font-normal">early adopters</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-10 duration-1000">
            <button className="w-full sm:w-auto px-12 py-5 bg-primary text-white rounded-2xl font-black text-lg hover:bg-primary-dark transition-all shadow-2xl shadow-emerald-900/20 active:scale-[0.98]">
              Get Started Now
            </button>
          ...
          <div className="hidden lg:block absolute inset-0 pointer-events-none overflow-hidden">
            ...
            <div className="absolute bottom-40 left-20 flex flex-col items-center gap-4 animate-in slide-in-from-bottom-10 duration-1000">
               ...
               <div className="w-10 h-10 rounded-xl bg-primary-light flex items-center justify-center text-primary shadow-md">
      ...
      <section className="py-24 bg-gray-50/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          <div className="text-center mb-20">
            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-primary mb-4 block">Our Placements</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {campaignOptions.map((opt, i) => (
              <div key={i} className="group flex flex-col p-10 bg-white border border-gray-100 rounded-[3.5rem] hover:border-primary-light hover:shadow-2xl hover:shadow-emerald-900/5 transition-all">
                <div className="flex items-center justify-between mb-8">
                  ...
                  <span className="text-[10px] font-black text-primary uppercase tracking-widest bg-primary-light px-3 py-1.5 rounded-full">{opt.tag}</span>
                </div>
                ...
                <button className="w-full py-4 bg-gray-900 text-white hover:bg-primary rounded-2xl font-black text-sm uppercase tracking-widest transition-all flex items-center justify-center gap-2 group/btn shadow-xl shadow-gray-900/10 active:scale-[0.98]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          <div className="bg-gray-900 rounded-[4rem] p-12 sm:p-20 text-white flex flex-col lg:flex-row items-center gap-16 overflow-hidden relative shadow-2xl shadow-emerald-900/10">
            <div className="absolute top-0 right-0 p-20 opacity-5 pointer-events-none">
              <Zap className="w-96 h-96 text-primary-light rotate-12" />
            </div>
            
            <div className="flex-1 relative z-10">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/30 text-primary-light rounded-full mb-8 border border-emerald-700/30">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-8 mb-12">
                 <div className="space-y-2">
                   <h4 className="font-black text-primary-light uppercase text-[10px] tracking-widest">Global Reach</h4>
                   <p className="text-sm font-bold text-emerald-50">Web, Newsletter, Social, and Community placements for maximum Ummah impact.</p>
                 </div>
                 <div className="space-y-2">
                   <h4 className="font-black text-primary-light uppercase text-[10px] tracking-widest">A/B Testing</h4>
                   <p className="text-sm font-bold text-emerald-50">Continuous creative optimization driven by data and community engagement.</p>
                 </div>
                 <div className="space-y-2">
                   <h4 className="font-black text-primary-light uppercase text-[10px] tracking-widest">Performance</h4>
                   <p className="text-sm font-bold text-emerald-50">Real-time reporting dashboards with granular conversion tracking.</p>
                 </div>
                 <div className="space-y-2">
                   <h4 className="font-black text-primary-light uppercase text-[10px] tracking-widest">White Glove</h4>
                   <p className="text-sm font-bold text-emerald-50">Dedicated account managers providing strategic insights and weekly syncs.</p>
                 </div>
              </div>

              <button className="px-12 py-5 bg-primary text-white rounded-2xl font-black text-lg hover:bg-emerald-700 transition-all shadow-xl shadow-emerald-900/40 active:scale-[0.98]">
                Schedule a Call
              </button>
            </div>
            ...
            <div className="w-full lg:w-1/3 flex flex-col gap-4 relative z-10">
               <div className="p-6 bg-white/5 border border-white/10 rounded-3xl backdrop-blur-xl">
                 <div className="flex items-center gap-4 mb-4">
                   <div className="w-10 h-10 rounded-full bg-primary-light0/20 flex items-center justify-center text-primary-light font-black">1</div>
               ...
               <div className="p-6 bg-white/5 border border-white/10 rounded-3xl backdrop-blur-xl translate-x-4">
                 <div className="flex items-center gap-4 mb-4">
                   <div className="w-10 h-10 rounded-full bg-primary-light0/20 flex items-center justify-center text-primary-light font-black">2</div>
               ...
               <div className="p-6 bg-white/5 border border-white/10 rounded-3xl backdrop-blur-xl translate-x-8">
                 <div className="flex items-center gap-4 mb-4">
                   <div className="w-10 h-10 rounded-full bg-primary-light0/20 flex items-center justify-center text-primary-light font-black">3</div>
      ...
      <section className="py-40 bg-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          <div className="w-20 h-20 bg-primary-light rounded-[2rem] flex items-center justify-center text-primary mx-auto mb-12 shadow-inner">
          ...
          <button className="px-16 py-6 bg-primary text-white rounded-[2.5rem] font-black text-xl hover:bg-primary-dark transition-all active:scale-[0.98] shadow-2xl shadow-emerald-900/30">
