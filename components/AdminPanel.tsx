    ...
    try {
      ...
      await supabase
        ...
        .insert([{
          ...
          type: 'approval',
          message: `Mabrook! Your product "${product.name}" has been authorized and is now live.`,
          is_read: false,
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
        <div className="space-y-3">
          <div className="flex items-center gap-3 text-emerald-800">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.3em]">Authorized Access • {AUTHORIZED_ADMIN_EMAIL}</span>
          </div>
