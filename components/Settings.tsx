...
import { CheckCircle, Github, Linkedin, X, Apple, Facebook, Twitter, Search } from 'lucide-react';
...
const Settings: React.FC<SettingsProps> = ({ onNavigate, currentView = View.SETTINGS }) => {
    ...
    // Sync activeTab with currentView prop changes
    React.useEffect(() => {
    ...
    const handleTabClick = (tabName: string) => {
        if (tabName === 'My details') {
            ...
            if (activeTab !== 'Followed products') {
    ...
    const renderContent = () => {
        if (loadingTab) return null; // content hidden while loading
                        ...
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <div className="relative w-64">
                                ...
                                <input
                                    type="text"
                                    placeholder="Search"
                                    className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded text-sm focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-all placeholder:text-gray-300"
                                />
                            </div>
                        </div>

                        <div className="py-20 text-center">
                            <p className="text-gray-500 text-lg">Nothin' here 🎉</p>
                            <p className="text-gray-400 text-sm mt-2 font-serif italic">Bismillah! Start following products to build your collection.</p>
                        </div>
                    </div>
                );
            case 'Verification':
                    ...
                    <div className="max-w-3xl">
                        ...
                        <div className="bg-white rounded-lg border border-gray-100 shadow-sm p-8 mb-16">
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <CheckCircle className="w-5 h-5 text-emerald-500 fill-current" />
                            </div>
                        ...
                        <div className="mb-16">
                            ...
                            <div className="mb-8">
                                ...
                                <input
                                    ...
                                    className="w-full max-w-md border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-emerald-600 focus:border-emerald-600 mb-4"
                                />
                            ...
                            <div className="mt-8 pt-8 border-t border-gray-100">
                                <div className="flex items-center justify-between mb-8">
                                    ...
                                    <button
                                        ...
                                        className={`w-11 h-6 rounded-full transition-colors relative ${unsubscribeAll ? 'bg-emerald-600' : 'bg-gray-200'} `}
                                    >
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <button
                                        ...
                                        className={`w-11 h-6 rounded-full transition-colors relative ${autoFollow ? 'bg-emerald-600' : 'bg-gray-200'} `}
                                    >
