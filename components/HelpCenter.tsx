...
const HelpCenter: React.FC<HelpCenterProps> = ({ onBack }) => {
    return (
        <div className="min-h-screen bg-gray-50 font-sans text-gray-900">
            {/* Header */}
            <div className="bg-[#ff6154] text-white py-24 px-4 flex flex-col items-center justify-center text-center">
                    ...
                    {[
                        ...
                        <div key={item.id} className="bg-white rounded-lg border border-gray-100 p-6 flex items-start gap-6 hover:shadow-md transition-shadow cursor-pointer">
                            <div className="shrink-0 pt-1">
                                <item.icon className="w-8 h-8 text-[#ff6154]" />
                            </div>
            ...
            <footer className="py-12 text-center text-gray-400 text-sm">
                ...
                <div className="mt-4 text-[#ff6154] hover:underline cursor-pointer">
