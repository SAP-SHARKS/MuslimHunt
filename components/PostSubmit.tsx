...
const PostSubmit: React.FC<PostSubmitProps> = ({ onCancel, onNext }) => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col lg:flex-row animate-in fade-in duration-500">
      ...
      <div className="lg:w-[45%] bg-primary-dark p-12 lg:p-24 flex flex-col justify-center relative overflow-hidden">
        <div className="absolute top-0 right-0 p-12 opacity-10 pointer-events-none">
          <Rocket className="w-64 h-64 text-primary-light rotate-12" />
        </div>
        
        <div className="relative z-10">
          <div className="w-16 h-16 bg-primary rounded-2xl flex items-center justify-center text-white mb-8 shadow-xl">
            <Sparkles className="w-8 h-8" />
          </div>
          <h1 className="text-4xl lg:text-6xl font-serif font-bold text-white leading-[1.1] mb-8 tracking-tight">
            The best new products, <br/><span className="text-primary-light">every day.</span>
          </h1>
        ...
        <div className="mt-20 pt-12 border-t border-primary relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="space-y-2">
              ...
              <div className="relative group">
                <div className={`absolute left-5 top-1/2 -translate-y-1/2 transition-colors ${url ? 'text-primary' : 'text-gray-400'}`}>
                ...
                <input
                  ...
                  className={`w-full pl-14 pr-6 py-5 bg-gray-50 border-2 transition-all rounded-[1.5rem] outline-none text-lg font-bold ${
                    error ? 'border-red-100 bg-red-50/30' : 'border-transparent focus:bg-white focus:border-primary'
                  }`}
                  autoFocus
                />
              </div>
          ...
          <div className="mt-16 p-6 bg-gray-50 rounded-2xl border border-gray-100 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-[13px] text-gray-500 font-medium leading-relaxed">
                We prefer products that are live and ready for users. Landing pages for future products are best shared in the <span className="text-primary font-bold">Forums</span>.
              </p>
            </div>
          </div>
        </div>
