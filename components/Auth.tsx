      ...
      <div className="relative bg-white rounded-[2.5rem] shadow-2xl border border-emerald-50 max-w-lg w-full overflow-hidden animate-in zoom-in-95 duration-300">
        ...
        <div className="p-8 sm:p-12">
          ...
          <div className="mb-8 text-center border-b border-gray-100 pb-8">
            <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-4 italic">Development Tools</p>
            <button
              onClick={onDevLogin}
              className="w-full flex items-center justify-center gap-2 py-3 bg-indigo-50 text-indigo-700 rounded-xl text-sm font-bold hover:bg-indigo-100 transition-all border border-indigo-100 shadow-sm active:scale-[0.98]"
            >
