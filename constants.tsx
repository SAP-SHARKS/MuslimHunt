...
export const INITIAL_PRODUCTS: Product[] = [
  {
    ...
    // Fixed: Renamed 'url' to 'website_url'
    ...
    // Fixed: Renamed 'founder_id' to 'user_id'
    user_id: 'u_1',
    ...
    comments: [
      {
        id: 'c1',
        user_id: 'u_1',
        // Fixed: Added missing 'product_id'
        product_id: '1',
  ...
  },
  {
    ...
    // Fixed: Renamed 'url' to 'website_url'
    website_url: 'https://example.com/ethicalwealth',
  ...
  },
  {
    ...
    // Fixed: Renamed 'url' to 'website_url'
    website_url: 'https://example.com/halalbite',
  ...
  },
  {
    ...
    // Fixed: Renamed 'url' to 'website_url'
    website_url: 'https://example.com/ummahhub',
  ...
  },
  {
    ...
    // Fixed: Renamed 'url' to 'website_url'
    website_url: 'https://example.com/sunnahwell',
