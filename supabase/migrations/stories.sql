-- Stories Tables
-- This migration creates tables for the Stories feature similar to Product Hunt
...
-- Create trigger for updated_at on stories
CREATE TRIGGER update_stories_updated_at
  BEFORE UPDATE ON stories
  FOR EACH ROW
  EXECUTE FUNCTION update_updated_at_column();

-- Create trigger for updated_at on story_comments
CREATE TRIGGER update_story_comments_updated_at
  BEFORE UPDATE ON story_comments
  FOR EACH ROW
  EXECUTE FUNCTION update_updated_at_column();

-- Sample stories data will be inserted separately
